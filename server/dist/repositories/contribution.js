...
exports.ContributionRepository = void 0;
const postgres_1 = __importDefault(require("../config/postgres"));
const contribution_1 = __importDefault(require("../models/contribution"));
const typedi_1 = require("typedi");
let ContributionRepository = class ContributionRepository {
    constructor() {
        this.repo = postgres_1.default.getRepository(contribution_1.default);
    }
...
exports.ContributionRepository = ContributionRepository;
exports.ContributionRepository = ContributionRepository = __decorate([
    (0, typedi_1.Service)(),
